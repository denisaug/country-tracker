/* countries-data.js — ISO 3166-1 alpha-2 reference (code → English name).
   Used by the "Add country" form: powers the suggestion datalist and the
   code→name auto-fill. No build step; just a plain global object. */
const COUNTRY_NAMES = {
  ...
  US: "United States", UM: "U.S. Minor Outlying Islands", UY: "Uruguay", UZ: "Uzbekistan", VU: "Vanuatu",
